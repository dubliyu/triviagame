...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.stackedWidget.setGeometry(QtCore.QRect(29, 19, 751, 511))
        self.stackedWidget.setObjectName("stackedWidget")
        self.page = QtWidgets.QWidget()
        self.page.setObjectName("page")
        self.horizontalLayoutWidget = QtWidgets.QWidget(self.page)
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(120, 420, 521, 71))
        ...
        self.graphicsView.setGeometry(QtCore.QRect(120, 10, 511, 371))
        self.graphicsView.setAutoFillBackground(False)
        self.graphicsView.setObjectName("graphicsView")
        self.label = QtWidgets.QLabel(self.page)
        self.label.setGeometry(QtCore.QRect(280, 390, 181, 20))
